...
export const experience: Experience[] = [
  {
    ...
    current: true,
    bullets: [
      "Develop features and improvements for Bank Indonesia Super Apps across Android and iOS.",
  ...
  },
  {
    ...
    bullets: [
      ...
      "Designed and implemented high-impact transaction-related features, streamlining the user journey.",
      "Partnered with UI/UX, BA, and QC teams to deliver high-fidelity designs and seamless product releases.",
      "Used GetX for state management to decouple business logic from the UI, resulting in cleaner code maintainability.",
      "Created a modular internal library to streamline feature development and ensure design consistency.",
      "Researched and integrated AI-powered development tools to automate boilerplate code generation.",
    ],
  ...
  },
  {
    ...
    bullets: [
      ...
      "Collaborated with Backend developers and UI/UX designers within an Agile environment.",
    ],
